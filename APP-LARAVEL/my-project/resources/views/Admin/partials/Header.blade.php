        ...
        <div class="flex items-center gap-4">
          ...
          <!-- Notification Menu Area -->
            ...
            <div class="relative">
                ...
                <div id="profile-menu" class="hidden absolute right-0 mt-2 flex-col p-3 w-52 bg-white dark:bg-gray-800 border rounded-lg shadow-lg">
                    <ul class="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-800">
                        <li>
                            <a href="Dashboard" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
